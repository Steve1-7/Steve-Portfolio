...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <nav className="fixed top-0 w-full bg-slate-900/80 backdrop-blur-md z-50 border-b border-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6">
            {["About", "Projects", "Skills", "Gallery", "Contact"].map(
              (item) => (
                <a
                  key={item}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl">
              ...
              technologies. Specializing in e-commerce solutions and custom web
              applications.
            </p>
      ...
      <section
        id="about"
        className="py-28 px-6 bg-slate-800/50 relative overflow-hidden"
      >
            ...
            <div>
              ...
              <div className="space-y-4 text-slate-400 text-lg leading-relaxed">
                <p>
                  ...
                  modern, responsive web applications that drive real business
                  results. I specialize in crafting seamless digital experiences
                  from concept to deployment.
                </p>
                <p>
                  With deep expertise in both frontend and backend technologies,
                  I've successfully delivered e-commerce platforms, corporate
                  websites, and developer tools for clients across various
                  industries.
                </p>
                <p>
              ...
              <div className="flex gap-4 mt-8">
                <a
                  href="mailto:stevezuluu@gmail.com"
                  className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold text-sm hover:shadow-lg hover:shadow-cyan-500/30 transition-all"
                >
                  Hire Me
                </a>
                <a
                  href="#projects"
                  className="px-6 py-3 border border-slate-600 rounded-lg font-semibold text-sm hover:border-cyan-400 hover:text-cyan-400 transition-all"
                >
                  See My Work
                </a>
              </div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              A showcase of my real-world projects — from full e-commerce
              platforms to corporate websites, design agencies, and developer
              tools.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="group relative bg-slate-800/60 rounded-3xl border border-slate-700 overflow-hidden hover:border-amber-500/50 transition-all duration-500">
              ...
              <div className="relative h-64 bg-slate-900 overflow-hidden">
                <iframe
                  loading="lazy"
                  src="http://stevemediaco.unaux.com"
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  <span className="px-3 py-1 bg-amber-500/90 text-slate-900 text-xs font-bold rounded-full">
                    ✂️ Barbershop
                  </span>
                  <span className="px-3 py-1 bg-slate-900/90 text-amber-400 text-xs font-bold rounded-full border border-amber-500/50">
                    🛍️ E-Commerce
                  </span>
                </div>
                <a
                  href="http://stevemediaco.unaux.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="absolute top-4 right-4 px-3 py-1.5 bg-slate-900/90 border border-slate-600 text-xs rounded-lg hover:border-amber-400 hover:text-amber-400 transition-all"
                >
                  Open Site →
                </a>
              </div>
              <div className="relative z-10 p-8">
                ...
                <p className="text-slate-400 mb-6 leading-relaxed">
                  A full-featured barbershop website with an integrated
                  e-commerce store. Customers can browse services, book
                  appointments online, shop for grooming products, and manage
                  their orders — all in one seamless platform.
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["Next.js", "Stripe", "Tailwind CSS", "MongoDB"].map(
                    (tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-slate-700/80 text-slate-300 rounded-full text-xs"
                      >
                        {tech}
                      </span>
                    )
            ...
            <div className="group relative bg-slate-800/60 rounded-3xl border border-slate-700 overflow-hidden hover:border-emerald-500/50 transition-all duration-500">
              ...
              <div className="relative h-64 bg-slate-900 overflow-hidden">
                <iframe
                  loading="lazy"
                  src="https://tory-cyan-2kxwuiasql.edgeone.app"
                  className="w-full h-full border-0"
                  style={{
                    width: "133%",
                    height: "133%",
                  ...
                  title="Saseka Woodworks"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-slate-800/80 to-transparent pointer-events-none" />
                <div className="absolute top-4 left-4 flex gap-2">
                  <span className="px-3 py-1 bg-emerald-500/90 text-slate-900 text-xs font-bold rounded-full">
                    🪵 Woodworks
                  </span>
                  <span className="px-3 py-1 bg-slate-900/90 text-emerald-400 text-xs font-bold rounded-full border border-emerald-500/50">
                    🛍️ E-Commerce
                  </span>
                </div>
                <a
                  href="https://tory-cyan-2kxwuiasql.edgeone.app"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="absolute top-4 right-4 px-3 py-1.5 bg-slate-900/90 border border-slate-600 text-xs rounded-lg hover:border-emerald-400 hover:text-emerald-400 transition-all"
                >
                  Open Site →
                </a>
              </div>
              <div className="relative z-10 p-8">
                ...
                <p className="text-slate-400 mb-6 leading-relaxed">
                  A premium e-commerce platform for custom woodwork products.
                  Showcases handcrafted furniture and décor with a product
                  gallery, custom quote requests, client portfolio, and
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {[
              {
                title: "C4 DesignHub",
                url: "https://c4designhub1.netlify.app",
                badge: "🎨 Design Agency",
                ...
                hoverBorder: "hover:border-rose-400 hover:text-rose-400",
              },
              {
                title: "Omnicreva",
                url: "https://omnicreva.ct.ws/",
                badge: "🌐 Corporate",
                ...
                hoverBorder: "hover:border-purple-400 hover:text-purple-400",
              },
              {
                title: "Patient Dashboard",
                url: "https://patient-dashboard.tiiny.site/",
                badge: "🏥 HealthTech",
                badgeColor: "bg-cyan-500/90 text-slate-900",
                border: "hover:border-cyan-500/50",
                glow: "from-cyan-500/5",
                linkColor: "text-cyan-400 hover:text-cyan-300",
                tech: ["React", "TypeScript", "Chart.js"],
                hoverBorder: "hover:border-cyan-400 hover:text-cyan-400",
              },
            ].map((project) => (
              <div
                key={project.title}
                className={`group relative bg-slate-800/60 rounded-2xl border border-slate-700 overflow-hidden ${project.border} transition-all duration-500`}
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${project.glow} to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                />
                <div className="relative h-44 bg-slate-900 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-800/80 to-transparent pointer-events-none" />
                  <span
                    className={`absolute top-3 left-3 px-2 py-1 ${project.badgeColor} text-xs font-bold rounded-full`}
                  >
                    {project.badge}
                  </span>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`absolute top-3 right-3 px-2 py-1 bg-slate-900/90 border border-slate-600 text-xs rounded-lg transition-all ${project.hoverBorder}`}
                  >
                    Open →
                  </a>
                </div>
                <div className="relative z-10 p-6">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-0.5 bg-slate-700/80 text-slate-300 rounded-full text-xs"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`text-sm font-medium transition-colors ${project.linkColor}`}
                  >
                    Live Demo →
                  </a>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="group relative bg-slate-800/60 rounded-2xl border border-slate-700 overflow-hidden hover:border-blue-500/50 transition-all duration-500 flex">
              ...
              <div className="relative z-10 p-6">
                ...
                <span className="inline-block mb-3 px-2 py-0.5 bg-blue-500/20 text-blue-400 text-xs rounded-full border border-blue-500/30">
                  🎬 Media Agency
                </span>
                <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                  Media and creative agency site showcasing services, portfolio,
                  and client work.
                </p>
                <div className="flex flex-wrap gap-1.5 mb-4">
                ...
                <a
                  href="https://stevemediaco.zya.me"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="group relative bg-slate-800/60 rounded-2xl border border-slate-700 overflow-hidden hover:border-yellow-500/50 transition-all duration-500 flex">
              ...
              <div className="relative z-10 p-6">
                ...
                <span className="inline-block mb-3 px-2 py-0.5 bg-yellow-500/20 text-yellow-400 text-xs rounded-full border border-yellow-500/30">
                  🚧 Under Development
                </span>
                <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                  Career tracking tool for developers — job applications, skill
                  assessments, and interview prep.
                </p>
                <div className="flex flex-wrap gap-1.5 mb-4">
          ...
          <div className="mt-16 text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 border border-slate-600 rounded-xl font-semibold hover:border-cyan-400 hover:text-cyan-400 transition-all"
            >
              View All on GitHub →
            </a>
          </div>
      ...
      <section id="skills" className="py-28 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-blue-500 mx-auto rounded-full mb-6" />
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              A full toolkit spanning frontend, backend, databases, design, and
              digital marketing — built through real-world projects and
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="group relative bg-slate-900/60 rounded-3xl border border-slate-700 hover:border-cyan-500/50 transition-all duration-500 overflow-hidden p-8">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center text-2xl shadow-lg shadow-cyan-500/20">
                    🖥️
                  </div>
                  <div>
                  ...
                  <span className="ml-auto px-3 py-1 bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-xs rounded-full font-medium">
                    8 Skills
                  </span>
                </div>
            ...
            <div className="group relative bg-slate-900/60 rounded-3xl border border-slate-700 hover:border-emerald-500/50 transition-all duration-500 overflow-hidden p-8">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-2xl shadow-lg shadow-emerald-500/20">
                    ⚙️
                  </div>
                  <div>
                  ...
                  <span className="ml-auto px-3 py-1 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs rounded-full font-medium">
                    6 Skills
                  </span>
                </div>
                <div className="space-y-3">
            ...
            {[
              {
                ...
                sweep: "from-orange-400 to-red-500",
                tools: [
                  { name: "Git", icon: "📦" },
                  { name: "Docker", icon: "🐳" },
                  { name: "Vercel", icon: "▲" },
                ...
                toolBorder: "hover:border-orange-500/50",
              },
              {
                title: "Design",
                ...
                sweep: "from-pink-400 to-rose-500",
                tools: [
                  { name: "Figma", icon: "🖊️" },
                ...
                toolBorder: "hover:border-pink-500/50",
              },
              {
                title: "Marketing",
                ...
                border: "hover:border-purple-500/50",
                sweep: "from-purple-400 to-indigo-500",
                tools: [
                ...
                toolBorder: "hover:border-purple-500/50",
              },
            ].map((group) => (
              <div
                key={group.title}
                className={`group relative bg-slate-900/60 rounded-3xl border border-slate-700 ${group.border} transition-all duration-500 overflow-hidden p-8`}
              >
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    <div
                      className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${group.color} flex items-center justify-center text-xl shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
                      {group.icon}
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {group.tools.map((tool) => (
                      <div
                        key={tool.name}
                        className={`flex items-center gap-2 bg-slate-800/60 border border-slate-700 rounded-xl px-3 py-2.5 ${group.toolBorder} transition-all duration-300`}
                      >
                ...
                <div
                  className={`absolute bottom-0 left-0 h-0.5 bg-gradient-to-r ${group.sweep} w-0 group-hover:w-full transition-all duration-700 rounded-full`}
                />
              </div>
            ))}
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-700 rounded-3xl p-8">
            <p className="text-center text-slate-400 text-sm uppercase tracking-widest mb-6 font-semibold">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                {
                  name: "Next.js",
                  color: "text-white border-slate-500/50 bg-slate-700/50",
                },
                {
                  name: "TypeScript",
                ...
                {
                  name: "MongoDB",
                  color: "text-green-500 border-green-600/30 bg-green-500/10",
                },
                {
                  name: "MySQL",
                  color:
                ...
                {
                  name: "Photoshop",
                  color: "text-blue-500 border-blue-600/30 bg-blue-500/10",
                },
                {
                  name: "3D Modelling",
                  color:
                ...
                <span
                  key={tag.name}
                  className={`px-4 py-2 rounded-full border text-sm font-medium ${tag.color} hover:scale-110 transition-transform duration-200 cursor-default`}
                >
                  {tag.name}
                </span>
              ))}
      ...
      <section id="contact" className="py-28 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="mailto:stevezuluu@gmail.com"
            className="inline-block px-10 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-cyan-500/50 transition-all mb-16"
          >
            Send Message
          </a>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={contact.label}
                className={`bg-slate-800/50 p-6 rounded-xl border border-slate-700 ${contact.color} transition-all`}
              >
      ...
      <footer className="py-8 px-6 border-t border-slate-800">
        <div className="max-w-6xl mx-auto text-center text-slate-400">
          <p className="mb-2">
            © 2025 Steve Ronald. Built with Next.js & Tailwind CSS
          </p>
          <p className="text-sm">
            Crafted with ❤️ and lots of ☕ | Open to new opportunities
          </p>
        </div>
      </footer>
    </div>
  ...
  const timelineData = [
    {
      ...
      bg: "bg-yellow-500/10",
      text: "Discovered creativity and curiosity for computers using school systems before owning one personally.",
      skills: ["Curiosity", "Problem Solving", "Creative Thinking"],
    },
    {
      date: "2019",
      title: "Self-Taught Digital Foundations",
      icon: "🖥️",
      ...
      bg: "bg-cyan-500/10",
      text: "Independently learned graphic design, digital marketing, and 3D modelling through online platforms.",
      skills: ["Graphic Design", "Digital Marketing", "3D Modelling"],
    },
    {
      date: "2019 – 2020",
      title: "Greenland Projects",
      icon: "💼",
      ...
      bg: "bg-green-500/10",
      text: "Digital Marketer and Assistant Web Manager until closure during COVID-19 lockdown.",
    ...
    },
    {
      ...
      bg: "bg-amber-500/10",
      text: "Part-time Graphic Designer and Web Manager, strengthening brand identity and online presence.",
      skills: ["Brand Identity", "Web Design", "Content Creation"],
    },
    {
      date: "2024 – 2025",
      title: "Shagary Petroleum",
      icon: "⚙️",
      ...
      bg: "bg-purple-500/10",
      text: "Web Developer and Graphic Designer, delivering design-led digital solutions.",
      skills: ["Web Development", "UI Design", "Corporate Branding"],
    },
    {
      date: "Present",
      ...
      bg: "bg-rose-500/10",
      text: "Building full-stack, AI-driven, and data-powered applications while expanding technical mastery.",
      skills: ["Full-Stack Dev", "AI Integration", "E-Commerce"],
    },
  ];
    ...
    <div className="mb-24">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-400 max-w-xl mx-auto">
          From early creativity to full-stack development across design, data,
          ...
          {timelineData.map((item, index) => (
            ...
            >
              <div className="hidden lg:flex absolute -top-16 left-1/2 -translate-x-1/2 flex-col items-center z-10">
                <div
                  className={`w-8 h-8 rounded-full bg-gradient-to-br ${item.color} flex items-center justify-center text-xs font-bold text-white shadow-lg`}
                >
                  {index + 1}
                </div>
              ...
              <div
                className={`relative bg-slate-900/60 rounded-2xl border p-6 transition-all duration-500 overflow-hidden ${
                  hoveredIndex === index
                    ? `${item.border} shadow-xl`
                    : "border-slate-700"
              ...
              >
                ...
                />
                <div
                  className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl ${item.color} opacity-5 rounded-bl-full transition-all duration-500 group-hover:opacity-10 group-hover:w-32 group-hover:h-32`}
                />
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-2xl shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
                      {item.icon}
                    </div>
                    <span
                      className={`text-xs font-bold px-3 py-1 rounded-full ${item.bg} ${item.accent} border ${item.border}`}
                    >
                      {item.date}
                    </span>
                  </div>
                  ...
                  >
                    <div
                      className={`mt-2 p-4 rounded-xl ${item.bg} border ${item.border}`}
                    >
                      <p
                        className={`text-sm font-semibold ${item.accent} mb-2`}
                      >
                        Key Takeaway
                      </p>
                      <p className="text-slate-300 text-sm">
                        Every step in this journey built the foundation for the
                        next — shaping the developer, designer, and problem
                        solver I am today.
                      </p>
                    </div>
                  </div>
                  <button
                    className={`mt-3 flex items-center gap-1 text-xs font-medium ${item.accent}`}
                  >
                    {activeIndex === index ? (
                      <>
                        <span>Show less</span>
...
type GalleryKey = "logos" | "modeling3d" | "packaging";

function Gallery() {
  const [active, setActive] = useState<GalleryKey>("logos");
  ...
  const galleries: Record<GalleryKey, { src: string; alt: string }[]> = {
    logos: [
  ...
  const handleCategoryChange = (categoryId: GalleryKey) => {
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-blue-500 mx-auto rounded-full mb-6" />
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            A curated collection of my graphic design work — from brand
            identities and logos to 3D renders and product packaging.
          </p>
        </div>
        ...
        <div className="flex justify-center gap-3 mb-12 flex-wrap">
          {categories.map((cat) => (
            <button
              key={cat.id}
              onClick={() => handleCategoryChange(cat.id as GalleryKey)}
            ...
            >
              ...
              <span className="ml-3 text-xs opacity-70">
                ({galleries[cat.id as GalleryKey].length})
              </span>
            </button>
          ))}
        </div>
        ...
        <div className="relative">
          ...
          <div className="flex justify-center gap-2 mt-6">
            {currentGallery.map((_: any, index: number) => (
              <button
                key={index}
                onClick={() => goToSlide(index)}
...
function CoreStrengths() {
  ...
  const strengths = [
    {
      ...
      color: "from-cyan-400 to-blue-500",
      border: "hover:border-cyan-500/50",
      glow: "from-cyan-500/10 to-blue-500/0",
      ...
      description:
        "Crafting responsive, modern websites with clean architecture and seamless user experiences across all devices.",
      features: [
        "Responsive Design",
        "SEO Optimized",
        "Fast Load Times",
    ...
    },
    {
      ...
      glow: "from-violet-500/10 to-purple-500/0",
      ...
      description:
        "Building full-featured web applications with rich interactivity, real-time data, and scalable backends.",
      features: [
        "Real-time Features",
        "REST & GraphQL APIs",
        "Authentication",
    ...
    },
    {
      ...
      description:
        "End-to-end online stores with payment integration, inventory management, and conversion-optimized UX.",
      features: [
        "Payment Gateways",
        "Inventory Systems",
        "Order Management",
      ...
      tags: ["Stripe", "Next.js", "Prisma", "MySQL"],
      stat: "5+ Stores Live",
    },
    {
      icon: "⚙️",
      ...
      color: "from-orange-400 to-red-500",
      border: "hover:border-orange-500/50",
      glow: "from-orange-500/10 to-red-500/0",
      ...
      description:
        "Developing robust tools, dashboards, and data-driven software solutions tailored to business workflows.",
      features: [
        "Custom Dashboards",
        "Data Pipelines",
        "Automation Tools",
      ...
      tags: ["TypeScript", "Docker", "REST APIs", "Git"],
      stat: "15+ Tools Built",
    },
    {
      icon: "🎨",
      ...
      color: "from-pink-400 to-rose-500",
      border: "hover:border-pink-500/50",
      glow: "from-pink-500/10 to-rose-500/0",
      ...
      description:
        "Creating compelling visual assets — logos, brand kits, posters, and marketing materials that make an impact.",
      features: [
        "Logo Design",
        "Brand Identity",
        "Print & Digital",
      ...
      tags: ["Photoshop", "Figma", "Illustrator", "Canva"],
    ...
    },
    {
      ...
      color: "from-purple-400 to-pink-500",
      border: "hover:border-purple-500/50",
      glow: "from-purple-500/10 to-pink-500/0",
      ...
      description:
        "Designing pixel-perfect, human-centered interfaces that are intuitive, accessible, and beautiful on every screen.",
      features: [
        "Wireframing",
        "Prototyping",
        "User Research",
      ...
      tags: ["Figma", "User Testing", "Accessibility", "Motion"],
      stat: "30+ UI Projects",
    },
    {
      icon: "🧊",
      ...
      glow: "from-sky-500/10 to-indigo-500/0",
      ...
      description:
        "Building 3D assets and visual concepts for products, architectural renders, and creative digital projects.",
      features: [
        "Product Renders",
        "3D Assets",
        "Visual Concepts",
      ...
      tags: ["Blender", "3D Design", "Rendering", "Texturing"],
      stat: "3D Since 2019",
    },
    {
      icon: "📣",
      ...
      description:
        "Driving online growth through strategic campaigns, content planning, and data-driven marketing decisions.",
      features: [
        "Campaign Strategy",
        "Content Planning",
        "Analytics",
      ...
      tags: ["Meta Ads", "Google Ads", "Analytics", "Email Marketing"],
      stat: "Since 2019",
    },
    {
      icon: "🔍",
      ...
      glow: "from-lime-500/10 to-green-500/0",
      ...
      description:
        "Optimizing websites to rank higher on search engines, drive organic traffic, and increase visibility.",
      features: [
        "On-page SEO",
        "Technical SEO",
        "Keyword Research",
      ...
      tags: ["Google Search", "Schema", "Core Web Vitals", "Analytics"],
      stat: "Top Rankings Achieved",
    },
  ];
  ...
  const filtered =
    filter === "All"
      ? strengths
      : strengths.filter((s) => s.category === filter);
    ...
    <div>
      <div className="text-center mb-14">
        ...
        <p className="text-slate-400 mt-4 max-w-xl mx-auto">
          A multidisciplinary skill set spanning development, design, and
          digital growth — built to deliver complete solutions from concept to
          launch.
        </p>
      </div>
        ...
        {filters.map((f) => (
          ...
          >
            ...
            <span className="ml-2 text-xs opacity-60">
              ...
              {f === "All"
                ? strengths.length
                : strengths.filter((s) => s.category === f).length}
              )
            </span>
          </button>
        ))}
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filtered.map((item, index) => (
          <div
            ...
            className={`group relative bg-slate-900/60 rounded-2xl border border-slate-700 ${
              item.border
            } p-7 transition-all duration-500 overflow-hidden cursor-pointer ${
              activeCard === index
                ? "ring-1 ring-cyan-400/40 scale-[1.02]"
                : "hover:scale-[1.01]"
            }`}
          >
            <div
              className={`absolute inset-0 bg-gradient-to-br ${item.glow} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl`}
            />
            <div
              className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl ${item.color} opacity-5 rounded-bl-full group-hover:opacity-10 group-hover:w-32 group-hover:h-32 transition-all duration-500`}
            />
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-5">
                <div
                  className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center text-2xl shadow-lg ${item.shadow} group-hover:scale-110 transition-transform duration-300`}
                >
                  {item.icon}
                </div>
                <div className="flex flex-col items-end gap-2">
                  <span
                    className={`text-xs font-bold px-3 py-1 rounded-full ${item.bg} ${item.accent} border ${item.tagBorder}`}
                  >
                    {item.category}
                  </span>
              ...
              >
                <div
                  className={`p-3 rounded-xl ${item.bg} border ${item.tagBorder} mb-3`}
                >
                  <p className={`text-xs font-semibold ${item.accent} mb-2`}>
                    Tech Stack
                  </p>
              ...
              <div className="flex items-center justify-between">
                <span className={`text-xs font-medium ${item.accent}`}>
                  {activeCard === index ? "▲ Less info" : "▼ Tech stack"}
                </span>
                <div
                  className={`h-0.5 bg-gradient-to-r ${
                    item.bar
                  } transition-all duration-700 rounded-full ${
                    activeCard === index ? "w-16" : "w-8 group-hover:w-16"
                  }`}
                />
              </div>
            </div>
            <div
              className={`absolute bottom-0 left-0 h-0.5 bg-gradient-to-r ${item.bar} transition-all duration-700 w-0 group-hover:w-full rounded-full`}
            />
          </div>
        ))}
      </div>
      ...
      <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={i}
            className="bg-slate-900/60 border border-slate-700 rounded-2xl p-5 text-center hover:border-slate-600 transition-all"
          >
      ...
      <div className="mt-10 bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 border border-slate-700 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <a
          href="mailto:stevezuluu@gmail.com"
          className="shrink-0 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl font-semibold hover:shadow-lg hover:shadow-cyan-500/30 transition-all whitespace-nowrap"
        >
          Let's Talk →
        </a>
      </div>
